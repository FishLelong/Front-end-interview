...
function create_if_block(ctx) {
	...
	return {
		c() {
			...
			t5 = space();
			li2 = element("li");
			li2.innerHTML = `<a class="navbar-item" href="#/dough">\$DOUGH</a>`;
			t7 = space();
			li3 = element("li");
...
function create_fragment(ctx) {
	...
	return {
		c() {
			...
			div2 = element("div");
			a1 = element("a");
			a1.innerHTML = `<button class="table-btn highlight-box">Buy \$DOUGH</button>`;
			t2 = space();
			span0 = element("span");
			span0.textContent = "🥧";
			t4 = space();
			a2 = element("a");
			a2.textContent = "Stake";
			t6 = space();
			span1 = element("span");
			span1.textContent = "🥧";
			t8 = space();
			a3 = element("a");
			a3.textContent = "$DOUGH";
			t10 = space();
			a4 = element("a");
			t11 = text(t11_value);
			t12 = space();
